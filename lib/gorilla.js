(function (GLOBAL) {
  ...
  var __everyPromise, __generatorToPromise, __import, __isArray, __lte, __num,
      ...
      os, parser, path, real__filename, setImmediate, SourceMap,
      writeFileWithMkdirp;
  ...
  fetchAndParsePreludeMacros = (function () {
    ...
    work = __generatorToPromise(function *() {
  ...
  exports.compileFile = __generatorToPromise(function *(options) {
    ...
    originalProgress = __num(sources.length) > 0 && options.progress;
    progressCounts = { parse: 0, macroExpand: 0, reduce: 0 };
    if (typeof originalProgress === "function") {
      options.progress = function (name, time) {
        return progressCounts[name] = __num(progressCounts[name]) + __num(time);
    ...
    _arr = [];
    for (_arr2 = __toArray(sources), i = 0, _len = _arr2.length; i < _len; ++i) {
      source = _arr2[i];
