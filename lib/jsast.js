(function () {
  ...
  function compileFunc(options, sb, name, params, declarations, variables, body, generator) {
  ...
  exports.Func = Func = (function (Expression) {
    ...
    function Func(pos, name, params, variables, body, declarations, generator) {
      var _this;
