(function () {
  ...
  MacroContext = (function () {
    ...
    function MacroContext(parser, index, position, inGenerator, inPromise, inEvilAst) {
      var _this;
    ...
    _MacroContext_prototype.func = function (params, body, bound, asType, isGenerator, isPromise) {
      ...
      func = ParserNode.InternalCall(
        ...
        isPromise instanceof Value ? isPromise : ParserNode.Value(body.index, !!isPromise)
      ).reduce(this.parser);
      ...
      if (obj === null || (_ref = typeof obj) === "string" || _ref === "number" || _ref === "boolean" || _ref === "undefined") {
        ...
        case 3:
          return ParserNode.Call(
            ...
            ParserNode.Value(obj.index, obj.inPromise),
    ...
    _MacroContext_prototype.macro = function (fromPosition, id, data, position, inGenerator, inPromise, inEvilAst) {
      var index;
      if (fromPosition && typeof fromPosition.index === "number") {
        index = fromPosition.index;
      } else {
      ...
      return ParserNode.MacroAccess(
        ...
        inPromise || this.parser.inPromise.peek(),
        inEvilAst
      ).reduce(this.parser);
    };
    return MacroContext;
