(function (GLOBAL) {
    ...
    Internal = (function (Symbol) {
      ...
      internalSymbols = {
        ...
        "function": {
          internalId: 13,
          doWrapArgs: false,
          validateArgs: function (params, body, bound, asType, isGenerator, isPromise) {
          ...
          _type: (function () {
            ...
            return function (call, parser) {
              ...
              if (_value === void 0) {
                ...
                } else if (call.args[5].constValue()) {
                  _value = Type.promise;
                } else {
        ...
        root: {
          internalId: 22,
          doWrapArgs: false,
          validateArgs: function (file, body, isEmbedded, isGenerator, isPromise) {
            var rest;
            rest = __slice.call(arguments, 5);
          },
          usedAsStatement: true
  ...
  MacroAccess = (function (Node) {
    ...
    function MacroAccess(index, scope, id, data, inStatement, inGenerator, inPromise, inEvilAst, doWrapped) {
      var _this;
    ...
    _MacroAccess_prototype.equals = (function () {
      ...
      return function (other) {
        if (other === this) {
          ...
          if (this.inStatement !== other.inStatement || this.inGenerator !== other.inGenerator || this.inPromise !== other.inPromise || this.inEvilAst !== other.inEvilAst || this.doWrapped !== other.doWrapped) {
            return false;
          } else {
