(function (GLOBAL) {
  ...
  var __bind, __cmp, __compose, __create, __curry, __import, __in, __isArray,
      ...
      GeneratorPromiseFunctionBody, getPackageVersion, getReservedIdents,
      GetSetToken, GreaterThan, GreaterThanChar, HashSignChar, HexDigit,
      HexEscapeSequence, HexNumber, Identifier, IdentifierNameConst,
  ...
  GeneratorPromiseFunctionBody = makeAlterStack("inPromise", true)(GeneratorFunctionBody);
  ...
  _FunctionDeclaration = (function () {
    ...
    function getBodyRule(generator, promise) {
      if (generator && promise) {
        return GeneratorPromiseFunctionBody;
      } else if (generator) {
