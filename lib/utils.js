(function () {
  "use strict";
  var __create, __in, __isArray, __owns, __slice, __toArray, __typeof, _ref,
      Cache, fs, inspect, isPrimordial, path;
  ...
  function writeFileWithMkdirp(filepath, text, encoding) {
